          ...
          <div class="grid-2-desktop">
            ...
            <div style="display:flex; justify-content:center; gap:var(--sp-4); margin-top:var(--sp-2); font-size:var(--fs-xs);">
              <span style="display:flex; align-items:center; gap:0.25rem;">
                <span style="width:12px; height:3px; background:#054fd4; display:inline-block; border-radius:2px;"></span> Calo thực tế
              </span>
              <span style="display:flex; align-items:center; gap:0.25rem;">
                <span style="width:12px; height:2px; border-top:2px dashed #7c4dff; display:inline-block;"></span> Mục tiêu TDEE (${tdee})
              </span>
            </div>
          </div>
